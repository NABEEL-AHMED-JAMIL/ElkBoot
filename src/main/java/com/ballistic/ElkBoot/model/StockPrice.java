...
@Document(indexName = "stock", type = "stockPrice")
public class StockPrice {
    ...
    public StockPrice(Date date, Double openPrice, Double highPrice, Double lowPrice, Double closePrice) {
        this.date = date;
    ...
    public StockPrice(Date date, Double openPrice, Double highPrice, Double lowPrice,
        Double closePrice, Double wap, Integer noOfShares, Integer noOfTrades, Double totalTurnover,
        Integer deliverableQuantity, Double deliQtyToTradedQty, Double spreadHighLow, Double spreadCloseOpen) {
        this.date = date;
        this.openPrice = openPrice;
        this.highPrice = highPrice;
        this.lowPrice = lowPrice;
